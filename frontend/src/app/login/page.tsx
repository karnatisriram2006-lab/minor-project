...
export default function Login() {
  ...
  return (
    <div className="h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#020617] text-white selection:bg-primary/20 font-sans noise-overlay">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10 bg-gradient-to-br from-[#020617] via-[#0B1120] to-[#020617]">
          <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-cyan-900/10 rounded-full blur-[160px] animate-pulse" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-slate-800/20 rounded-full blur-[120px] animate-pulse [animation-delay:-4s]" />
      </div>
        ...
        >
          <Link href="/" className="flex flex-col items-center justify-center gap-4 group cursor-pointer">
            ...
            <div className="text-center space-y-1">
               <span className="font-black text-3xl tracking-tighter text-white block group-hover:text-primary transition-colors italic leading-none font-serif">Identity Sync.</span>
               <p className="text-[8px] font-black uppercase tracking-[0.6em] text-white/30 hidden sm:block">Authorized Heritage Node</p>
            </div>
          </Link>
        </motion.div>
          ...
          <Card className="bg-[#0B1120]/40 backdrop-blur-3xl rounded-[2rem] border border-white/5 shadow-2xl overflow-hidden glass-3d">
            <CardHeader className="space-y-2 text-center border-b border-white/5 p-6 bg-white/[0.01]">
              <div className="flex justify-center mb-1">
                 <div className="bg-white/5 px-4 py-1.5 rounded-full flex items-center gap-2 border border-white/10 backdrop-blur-md">
                    ...
                    <span className="text-[8px] font-black uppercase tracking-[0.3em] text-white/80">Biometric Encrypted</span>
                 </div>
              </div>
              <CardTitle className="text-2xl font-black tracking-tighter italic text-white leading-tight font-serif">Welcome Back.</CardTitle>
              <CardDescription className="text-white/40 font-medium text-xs leading-relaxed px-4 italic">
                One-click synchronization to resume your Indian odyssey.
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex flex-col space-y-4 pt-4 pb-6 bg-white/[0.01] border-t border-white/5">
              <div className="text-[11px] font-bold text-center text-white/40 tracking-wide uppercase">
                New to the Matrix?{" "}
                <Link href="/register" className="text-white hover:text-primary transition-colors cursor-pointer italic underline underline-offset-4 decoration-white/20">
                  Spawn Identity
                </Link>
              </div>
            </CardFooter>
