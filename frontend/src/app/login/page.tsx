...
export default function Login() {
  ...
  return (
    <div className="h-screen flex items-center justify-center p-6 bg-heritage-bone text-heritage-onyx font-sans relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10" style={{ background: 'radial-gradient(circle at bottom left, #76767608, transparent 40%)' }} />
        ...
        >
          <Card className="bg-white rounded-[2.5rem] border border-heritage-gold/10 shadow-premium overflow-hidden">
            <CardHeader className="space-y-4 text-center border-b border-heritage-bone p-10">
              <CardTitle className="text-3xl font-black text-heritage-onyx tracking-tighter italic">Ascend.</CardTitle>
              <CardDescription className="text-heritage-onyx/40 font-medium text-base leading-relaxed italic">
                Synchronize your presence to continue the premium journey.
              </CardDescription>
            </CardHeader>
              ...
              >
                {loading ? (
                   <div className="flex items-center gap-4 text-white/60">
                      ...
                      <span className="font-black text-xs uppercase tracking-widest">Inhabiting...</span>
                   </div>
                ) : (
                  <>
                    ...
                    <span className="font-black text-xs uppercase tracking-[0.3em]">Sync Presence</span>
                  </>
                )}
              </Button>
            </CardContent>
            <CardFooter className="flex flex-col space-y-6 pt-6 pb-10 bg-heritage-bone/30 border-t border-heritage-bone">
              <div className="text-[10px] font-black text-center text-heritage-onyx/30 uppercase tracking-[0.3em]">
                New traveler?{" "}
                <Link href="/register" className="text-heritage-saffron hover:underline underline-offset-8 transition-all px-2">
                  Initialize Profile
                </Link>
              </div>
            </CardFooter>
