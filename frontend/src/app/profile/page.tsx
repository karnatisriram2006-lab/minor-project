...
const TRAVEL_STYLES = [
  {
    value: "backpacker",
    label: "Backpacker",
    desc: "Budget-friendly, off-the-beaten-path",
  },
  {
    value: "comfort",
    label: "Comfort",
    desc: "Balanced experience with nice stays",
  },
    ...
    <div className="min-h-screen bg-[#F7F7F7] dark:bg-[#0F0F0F] text-[#484848] dark:text-[#E0E0E0] pt-6 pb-24 sm:pt-8 sm:pb-12 font-sans">
      <div className="container mx-auto px-6 max-w-2xl space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-[#767676] dark:text-[#888]">
            Manage your travel preferences and account details.
          </p>
        </div>
        ...
        >
          ...
          <div>
            <h2 className="text-xl font-bold text-[#484848] dark:text-[#E0E0E0]">
              {displayName}
            </h2>
            <p className="text-sm text-[#767676] dark:text-[#888]">
              {user.email}
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[#EBEBEB] dark:border-[#2A2A2A]">
            <div className="space-y-1">
              <p className="text-2xl font-black text-[#FF5A5F]">
                {stats.trips}
              </p>
              <p className="text-[10px] font-semibold uppercase tracking-wider text-[#767676] dark:text-[#888]">
                Trips
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-2xl font-black text-[#00A699]">
                {stats.destinations}
              </p>
              <p className="text-[10px] font-semibold uppercase tracking-wider text-[#767676] dark:text-[#888]">
                Destinations
        ...
        >
          <h3 className="text-base font-bold text-[#484848] dark:text-[#E0E0E0]">
            Travel Preferences
          </h3>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={languages[0]}
              onValueChange={(v) => setLanguages([v, ...languages.slice(1)])}
            >
              ...
              <SelectContent className="rounded-xl bg-white dark:bg-[#1A1A1A] border-[#EBEBEB] dark:border-[#2A2A2A]">
                {[
                  ...
                  <SelectItem
                    key={lang}
                    value={lang}
                    className="text-sm font-medium text-[#484848] dark:text-[#E0E0E0]"
                  >
                    {lang}
                  </SelectItem>
                ))}
              ...
              {TRAVEL_STYLES.map((style) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#767676] dark:text-[#888]">
                      {style.desc}
                    </p>
                  </div>
                </button>
          ...
          {/* Interests */}
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-[#767676] dark:text-[#888] uppercase tracking-wide">
              Interests
            </Label>
